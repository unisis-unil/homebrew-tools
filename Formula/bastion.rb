class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.17.0", revision: "c0c64490d5ceb8a30e83f56daa82e55216cc1eba"
  license "MIT"
  ...
  test do
    assert_match "0.17.0", shell_output("#{bin}/bastion --version")
  end
end
