class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.3.1", revision: "eab75ccec1fb3d0063af5e54ca64a75db64e9ad0"
  license "MIT"
  ...
  test do
    assert_match "0.3.1", shell_output("#{bin}/bastion --version")
  end
end
