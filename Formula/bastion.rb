class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.3.0", revision: "d8e43047a9e84b7f75f1a1dab8d5e3ccf4225158"
  license "MIT"
  ...
  test do
    assert_match "0.3.0", shell_output("#{bin}/bastion --version")
  end
end
