class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.14", revision: "283e46ea8e7073dbe84346ba9fe47957345dd8a7"
  license "MIT"
  ...
  test do
    assert_match "0.8.14", shell_output("#{bin}/bastion --version")
  end
end
