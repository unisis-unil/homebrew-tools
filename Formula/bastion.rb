class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.4.4", revision: "b97a92a47aae83dcef603f5d562c63ecb609aa39"
  license "MIT"
  ...
  test do
    assert_match "0.4.4", shell_output("#{bin}/bastion --version")
  end
end
