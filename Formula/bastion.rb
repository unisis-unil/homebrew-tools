class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.9.1", revision: "9570543aaea71332f9fd89719e681a4c04335fbd"
  license "MIT"
  ...
  test do
    assert_match "0.9.1", shell_output("#{bin}/bastion --version")
  end
end
