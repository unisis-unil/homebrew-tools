class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.3.3", revision: "5195943e5ac4dcd2436fa85512348b6dd6351943"
  license "MIT"
  ...
  test do
    assert_match "0.3.3", shell_output("#{bin}/bastion --version")
  end
end
