class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.9", revision: "a5f75d204ff11609d95109cf5c5ee6df534cce40"
  license "MIT"
  ...
  test do
    assert_match "0.8.9", shell_output("#{bin}/bastion --version")
  end
end
