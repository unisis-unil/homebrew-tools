class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.1", revision: "07851dcfe1c3289cd849f4d2d7ba37c6d05cc44e"
  license "MIT"
  ...
  test do
    assert_match "0.2.1", shell_output("#{bin}/bastion --version")
  end
end
