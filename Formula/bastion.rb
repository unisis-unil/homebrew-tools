class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.5.2", revision: "3e38da7a6defaa841bc26faf30b65a9c80628123"
  license "MIT"
  ...
  test do
    assert_match "0.5.2", shell_output("#{bin}/bastion --version")
  end
end
