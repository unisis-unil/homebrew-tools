class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.6.2", revision: "6744a57cdf404d3b9942bcdbb77c9712aadf0569"
  license "MIT"
  ...
  test do
    assert_match "0.6.2", shell_output("#{bin}/bastion --version")
  end
end
