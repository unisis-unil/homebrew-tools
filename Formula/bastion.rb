class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.6", revision: "98ee185f93c569dbfb1850a6b863264d73e80c1c"
  license "MIT"
  ...
  test do
    assert_match "0.8.6", shell_output("#{bin}/bastion --version")
  end
end
