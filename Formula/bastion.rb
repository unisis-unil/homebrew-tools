class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.7", revision: "63800eddb3b57638f5fa34cccfe83d54bfc8db74"
  license "MIT"
  ...
  test do
    assert_match "0.8.7", shell_output("#{bin}/bastion --version")
  end
end
