class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.4.5", revision: "d6a549d4a048091ac489b15fc56639698248d4ad"
  license "MIT"
  ...
  test do
    assert_match "0.4.5", shell_output("#{bin}/bastion --version")
  end
end
