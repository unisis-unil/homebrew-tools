class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.1", revision: "d07958f39ce63f8245cc4680f1da50736fcea43f"
  license "MIT"
  ...
  test do
    assert_match "0.8.1", shell_output("#{bin}/bastion --version")
  end
end
