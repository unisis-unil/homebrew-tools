class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.19", revision: "eac74604e83a678bf705a33941001a8c129cacb2"
  license "MIT"
  ...
  test do
    assert_match "0.8.19", shell_output("#{bin}/bastion --version")
  end
end
