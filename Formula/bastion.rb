class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.7", revision: "cf31be0103c69a84061eafb73f3aaac16802ddbb"
  license "MIT"
  ...
  test do
    assert_match "0.2.7", shell_output("#{bin}/bastion --version")
  end
end
