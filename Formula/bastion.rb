class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.14.0", revision: "55d827a4dad402c7a0041b762509f1df0a434510"
  license "MIT"
  ...
  test do
    assert_match "0.14.0", shell_output("#{bin}/bastion --version")
  end
end
