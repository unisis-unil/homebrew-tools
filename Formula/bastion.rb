class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.3", revision: "d11c6706bc017fad2ff21eacbd34b778a438dd11"
  license "MIT"
  ...
  test do
    assert_match "0.8.3", shell_output("#{bin}/bastion --version")
  end
end
