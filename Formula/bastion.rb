class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.4.0", revision: "0725de37c117f1d9fb5b1964fab4714c08a38f4b"
  license "MIT"
  ...
  test do
    assert_match "0.4.0", shell_output("#{bin}/bastion --version")
  end
end
