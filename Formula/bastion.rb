class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.7.0", revision: "5f0f9278ff338d9628d175087cacac73052dd0dc"
  license "MIT"
  ...
  test do
    assert_match "0.7.0", shell_output("#{bin}/bastion --version")
  end
end
