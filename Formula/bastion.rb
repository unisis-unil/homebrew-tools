class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.10.0", revision: "4d812eab36499cb4e7985bff7c8de7a02b2ef195"
  license "MIT"
  ...
  test do
    assert_match "0.10.0", shell_output("#{bin}/bastion --version")
  end
end
