class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.5.1", revision: "c12346fb6200224807e3276bf4e778eca0a5182e"
  license "MIT"
  ...
  test do
    assert_match "0.5.1", shell_output("#{bin}/bastion --version")
  end
end
