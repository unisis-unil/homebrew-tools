class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.1.6", revision: "7fc8e26bd82a96916a96577c35f8a05b81a3f4bd"
  license "MIT"
  ...
  test do
    assert_match "0.1.6", shell_output("#{bin}/bastion --version")
  end
end
