class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.7.2", revision: "fa0dfe511934b52fdb49c1dc9bca5cf0e668ec6a"
  license "MIT"
  ...
  test do
    assert_match "0.7.2", shell_output("#{bin}/bastion --version")
  end
end
