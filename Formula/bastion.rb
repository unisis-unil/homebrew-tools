class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.6", revision: "c4f077727c05927a1fa33a20ee554fd06fabd43a"
  license "MIT"
  ...
  test do
    assert_match "0.2.6", shell_output("#{bin}/bastion --version")
  end
end
