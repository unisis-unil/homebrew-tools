class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.1.1", revision: "7ef3b1aa510d87e9765fc722c1eb4767edc8cc98"
  license "MIT"
  ...
  test do
    assert_match "0.1.1", shell_output("#{bin}/bastion --version")
  end
end
