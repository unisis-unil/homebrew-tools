class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.6.1", revision: "5162ee9e6fe200bd65c3358ec532b1d824b04c9e"
  license "MIT"
  ...
  test do
    assert_match "0.6.1", shell_output("#{bin}/bastion --version")
  end
end
