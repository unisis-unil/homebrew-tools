class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.1.0", revision: "699a49d96ffff338f564eeb62f4adf28ceb8a71d"
  license "MIT"
  ...
  test do
    assert_match "0.1.0", shell_output("#{bin}/bastion --version")
  end
end
