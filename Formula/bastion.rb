class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.6.0", revision: "3ab937bdacdc45f9dde083a53dd089e51f4313eb"
  license "MIT"
  ...
  test do
    assert_match "0.6.0", shell_output("#{bin}/bastion --version")
  end
end
