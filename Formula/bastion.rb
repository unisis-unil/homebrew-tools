class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.4.3", revision: "113bed59675fb3761a9408be2efc071241adbe9a"
  license "MIT"
  ...
  test do
    assert_match "0.4.3", shell_output("#{bin}/bastion --version")
  end
end
