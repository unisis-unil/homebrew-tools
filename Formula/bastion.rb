class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.13.0", revision: "a1dc6b026be7f441a628af64d937e49141770611"
  license "MIT"
  ...
  test do
    assert_match "0.13.0", shell_output("#{bin}/bastion --version")
  end
end
