class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.10", revision: "6d84e17b5942ec25c8865df3bba0ebad82d88d61"
  license "MIT"
  ...
  test do
    assert_match "0.8.10", shell_output("#{bin}/bastion --version")
  end
end
