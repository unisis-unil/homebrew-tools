class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.4.6", revision: "9b2ac7be0b4865779a2f98ff019b252da7265b18"
  license "MIT"
  ...
  test do
    assert_match "0.4.6", shell_output("#{bin}/bastion --version")
  end
end
