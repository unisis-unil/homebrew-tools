class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.1.2", revision: "f051b2dc49ff11fa01367788f153d6e8f6e60066"
  license "MIT"
  ...
  test do
    assert_match "0.1.2", shell_output("#{bin}/bastion --version")
  end
end
