class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.13", revision: "9a883282384425b5afaf891a7681085a4d6a2f40"
  license "MIT"
  ...
  test do
    assert_match "0.8.13", shell_output("#{bin}/bastion --version")
  end
end
