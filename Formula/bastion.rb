class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.5", revision: "cb07ab2cc19847369f3b70024bad327ee81e7ee6"
  license "MIT"
  ...
  test do
    assert_match "0.2.5", shell_output("#{bin}/bastion --version")
  end
end
