class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.15", revision: "eb1035eaf74295aa42824c40487c608d5adb28a8"
  license "MIT"
  ...
  test do
    assert_match "0.8.15", shell_output("#{bin}/bastion --version")
  end
end
