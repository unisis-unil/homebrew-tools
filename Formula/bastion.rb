class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.7.3", revision: "ee7aea2e74d9c2336bc1f8c238cd09e6f145959d"
  license "MIT"
  ...
  test do
    assert_match "0.7.3", shell_output("#{bin}/bastion --version")
  end
end
