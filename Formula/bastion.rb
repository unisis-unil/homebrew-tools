class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.11", revision: "b0ab7339415a6e2c02e2f34d0aefe9773338da23"
  license "MIT"
  ...
  test do
    assert_match "0.8.11", shell_output("#{bin}/bastion --version")
  end
end
