class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.16.0", revision: "8b3c099c680f6bf32ce8dfbf6c02230e0edfe082"
  license "MIT"
  ...
  test do
    assert_match "0.16.0", shell_output("#{bin}/bastion --version")
  end
end
