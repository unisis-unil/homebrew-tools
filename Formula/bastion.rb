class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.15.0", revision: "9ba36b4def9ee8cd1fc21fa344f85ccec149a4c0"
  license "MIT"
  ...
  test do
    assert_match "0.15.0", shell_output("#{bin}/bastion --version")
  end
end
