class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.3.2", revision: "d8ea9d7dd862dc21eee27bb3edc952ce45c4878e"
  license "MIT"
  ...
  test do
    assert_match "0.3.2", shell_output("#{bin}/bastion --version")
  end
end
