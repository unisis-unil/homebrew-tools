class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.0", revision: "13b17537492018705504b37a685e80d2b5d0fbb6"
  license "MIT"
  ...
  test do
    assert_match "0.2.0", shell_output("#{bin}/bastion --version")
  end
end
