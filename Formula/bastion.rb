class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.4", revision: "d15a58565a3fd1095c733e00599af004673ded92"
  license "MIT"
  ...
  test do
    assert_match "0.8.4", shell_output("#{bin}/bastion --version")
  end
end
