class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.18", revision: "ec1817df94ee29c3ac0487f75eb0acdb28585f77"
  license "MIT"
  ...
  test do
    assert_match "0.8.18", shell_output("#{bin}/bastion --version")
  end
end
