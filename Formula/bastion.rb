class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.12", revision: "2d9c75dec6f24d572b39aca7f4a9bdfdd81668a1"
  license "MIT"
  ...
  test do
    assert_match "0.8.12", shell_output("#{bin}/bastion --version")
  end
end
