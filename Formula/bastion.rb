class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.2.4", revision: "d8cb3a8b3e27359a705569ad108f748c64919826"
  license "MIT"
  ...
  test do
    assert_match "0.2.4", shell_output("#{bin}/bastion --version")
  end
end
