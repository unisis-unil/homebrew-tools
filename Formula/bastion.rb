class Bastion < Formula
  ...
  url "https://github.com/unisis-unil/bastion-ansible.git", tag: "v0.8.8", revision: "e37e131ba248687a945f133f8bc1de7669894d01"
  license "MIT"
  ...
  test do
    assert_match "0.8.8", shell_output("#{bin}/bastion --version")
  end
end
