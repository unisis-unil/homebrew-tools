class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.4", revision: "c5fc51bb8af91a32911d92ae9484810cda358c9a"
  license "MIT"
  ...
  test do
    assert_match "0.12.4", shell_output("#{bin}/endreas --version")
  end
end
