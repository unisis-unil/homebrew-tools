class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.2", revision: "f8e587c51b3d17a10346e7efbbca402bdaba7b40"
  license "MIT"
  ...
  test do
    assert_match "0.12.2", shell_output("#{bin}/endreas --version")
  end
end
