class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.11", revision: "7540534993aa31f7500e365bfb4f520d94194760"
  license "MIT"
  ...
  test do
    assert_match "0.4.11", shell_output("#{bin}/endreas --version")
  end
end
