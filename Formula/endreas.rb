class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.9.3", revision: "6cf8548a4210badba2af95c2d52cb05010f12873"
  license "MIT"
  ...
  test do
    assert_match "0.9.3", shell_output("#{bin}/endreas --version")
  end
end
