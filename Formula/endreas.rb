class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.6", revision: "88c82d07aa0a71601748b0689324b62a4aff5c8f"
  license "MIT"
  ...
  test do
    assert_match "0.4.6", shell_output("#{bin}/endreas --version")
  end
end
