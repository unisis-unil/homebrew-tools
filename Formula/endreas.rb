class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.17.1", revision: "fc228a839088fd91bdb1e85af43c18044e9a3ce6"
  license "MIT"
  ...
  test do
    assert_match "0.17.1", shell_output("#{bin}/endreas --version")
  end
end
