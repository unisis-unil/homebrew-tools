class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.17.0", revision: "bafc4f1bbaacb2c07bd81f9c956440852d6460e8"
  license "MIT"
  ...
  test do
    assert_match "0.17.0", shell_output("#{bin}/endreas --version")
  end
end
