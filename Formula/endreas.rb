class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.4", revision: "8678bdbf61e5ffc4fb6c981175a2cad2106d6999"
  license "MIT"
  ...
  test do
    assert_match "0.4.4", shell_output("#{bin}/endreas --version")
  end
end
