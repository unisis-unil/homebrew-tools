class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.9.0", revision: "d2fe33b08777aee215e99255f62e2bd92dad703d"
  license "MIT"
  ...
  test do
    assert_match "0.9.0", shell_output("#{bin}/endreas --version")
  end
end
