class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.0", revision: "b64d61fbc712dd8fc768819ec55a2fb94b32d79b"
  license "MIT"
  ...
  test do
    assert_match "0.12.0", shell_output("#{bin}/endreas --version")
  end
end
