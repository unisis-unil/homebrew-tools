class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.3", revision: "fa6ab1019dcc3b66849c13aec997bf5002a058ea"
  license "MIT"
  ...
  test do
    assert_match "0.4.3", shell_output("#{bin}/endreas --version")
  end
end
