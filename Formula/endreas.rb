class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.1", revision: "645a0b87a4733a335cdaf201fe61074917e3b494"
  license "MIT"
  ...
  test do
    assert_match "0.12.1", shell_output("#{bin}/endreas --version")
  end
end
