class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.9.4", revision: "e77aa263d4f6cbfcfcb5b828df60feafd43293f6"
  license "MIT"
  ...
  test do
    assert_match "0.9.4", shell_output("#{bin}/endreas --version")
  end
end
