class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.17.2", revision: "d9e1fb144287c808ff217fdf7a320a1dbf4b3036"
  license "MIT"
  ...
  test do
    assert_match "0.17.2", shell_output("#{bin}/endreas --version")
  end
end
