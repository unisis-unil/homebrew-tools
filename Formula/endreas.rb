class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.1", revision: "d6f7fc06a59c6932c6319e33e3d9e4d10c1fbb2c"
  license "MIT"
  ...
  test do
    assert_match "0.4.1", shell_output("#{bin}/endreas --version")
  end
end
