class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.19.1", revision: "201dfa2c40b61d9783bcb6f073fa0b71a00ec9c7"
  license "MIT"
  ...
  test do
    assert_match "0.19.1", shell_output("#{bin}/endreas --version")
  end
end
