class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.14.0", revision: "dd6419cca7a1dc9c5a9295796c1b4645350bd918"
  license "MIT"
  ...
  test do
    assert_match "0.14.0", shell_output("#{bin}/endreas --version")
  end
end
