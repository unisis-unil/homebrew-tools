class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.13", revision: "bbf75931bd35de31f13467f6b1c0a29d4f46f644"
  license "MIT"
  ...
  test do
    assert_match "0.4.13", shell_output("#{bin}/endreas --version")
  end
end
