class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.18.1", revision: "9e159ca1904365030bd87aba97d437ccb0d4355c"
  license "MIT"
  ...
  test do
    assert_match "0.18.1", shell_output("#{bin}/endreas --version")
  end
end
