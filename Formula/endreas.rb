class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.2", revision: "9729f35e55403b57f6861f46c0f7237c60c23fbd"
  license "MIT"
  ...
  test do
    assert_match "0.4.2", shell_output("#{bin}/endreas --version")
  end
end
