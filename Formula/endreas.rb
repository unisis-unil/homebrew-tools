class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.12", revision: "9ba45b16230723750ad2cd3974fcbe99fba0fae0"
  license "MIT"
  ...
  test do
    assert_match "0.4.12", shell_output("#{bin}/endreas --version")
  end
end
