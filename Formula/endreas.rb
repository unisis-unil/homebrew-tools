class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.6.0", revision: "ea2290a0bd599de7274388972a78f240eb43813b"
  license "MIT"
  ...
  test do
    assert_match "0.6.0", shell_output("#{bin}/endreas --version")
  end
end
