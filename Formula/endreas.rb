class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.18.0", revision: "ffbe3c3cc47742c0fd003d4337c4cae31acf5df7"
  license "MIT"
  ...
  test do
    assert_match "0.18.0", shell_output("#{bin}/endreas --version")
  end
end
