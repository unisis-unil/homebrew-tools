class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.8.0", revision: "0c6be0dc899b2d8f8fdb35fb73828d09dd8e2c6b"
  license "MIT"
  ...
  test do
    assert_match "0.8.0", shell_output("#{bin}/endreas --version")
  end
end
