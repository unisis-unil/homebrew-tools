class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.3", revision: "1a9c610324ff37f8b1fdc9ed0b1c2291b2b37b3e"
  license "MIT"
  ...
  test do
    assert_match "0.12.3", shell_output("#{bin}/endreas --version")
  end
end
