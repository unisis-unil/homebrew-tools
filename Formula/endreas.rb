class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.7.0", revision: "96358c0105a6623bccaa138892c05efc453a3a4e"
  license "MIT"
  ...
  test do
    assert_match "0.7.0", shell_output("#{bin}/endreas --version")
  end
end
