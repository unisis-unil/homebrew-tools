class Endreas < Formula
  ...
  url "ssh://git@github.com/unisis-unil/endreas-cli.git", tag: "v0.21.2", revision: "73dd0d2f1a050051cc7864a09b8b07309dcd6fe7"
  license "MIT"
  ...
  test do
    assert_match "0.21.2", shell_output("#{bin}/endreas --version")
  end
end
