class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.9", revision: "405180d85fa7b4bf6a9adad9ffb5d1cef557b917"
  license "MIT"
  ...
  test do
    assert_match "0.4.9", shell_output("#{bin}/endreas --version")
  end
end
