class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.10.0", revision: "0fc85b3747bb5455c0c914d51bc3b795e29406a8"
  license "MIT"
  ...
  test do
    assert_match "0.10.0", shell_output("#{bin}/endreas --version")
  end
end
