class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.19.0", revision: "3a16f9dc500f2fa22bf439ced0e5fa724608b2a3"
  license "MIT"
  ...
  test do
    assert_match "0.19.0", shell_output("#{bin}/endreas --version")
  end
end
