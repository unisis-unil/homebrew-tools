class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.10", revision: "18f0f0a99b16722b85d76da8d36a891c3948687f"
  license "MIT"
  ...
  test do
    assert_match "0.4.10", shell_output("#{bin}/endreas --version")
  end
end
