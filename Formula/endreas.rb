class Endreas < Formula
  ...
  url "ssh://git@github.com/unisis-unil/endreas-cli.git", tag: "v0.21.1", revision: "3823cde7d0325442b492d19da0272575b047d88e"
  license "MIT"
  ...
  test do
    assert_match "0.21.1", shell_output("#{bin}/endreas --version")
  end
end
