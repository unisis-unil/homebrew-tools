class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.5.0", revision: "cba5f5d288279718702cd4da1c7fed9f59b74aa2"
  license "MIT"
  ...
  test do
    assert_match "0.5.0", shell_output("#{bin}/endreas --version")
  end
end
