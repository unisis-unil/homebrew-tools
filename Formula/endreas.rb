class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.2.0", revision: "ab8e8e3860a30265778e79c3e9c3103a18024a03"
  license "MIT"
  ...
  test do
    assert_match "0.2.0", shell_output("#{bin}/endreas --version")
  end
end
