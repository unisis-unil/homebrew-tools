class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.18.2", revision: "e5096752d92d7d1f46206c3976e92f0895e91db3"
  license "MIT"
  ...
  test do
    assert_match "0.18.2", shell_output("#{bin}/endreas --version")
  end
end
