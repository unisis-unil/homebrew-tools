class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.12.5", revision: "0436547efe06505d8d464909e9bc3d979c21bb42"
  license "MIT"
  ...
  test do
    assert_match "0.12.5", shell_output("#{bin}/endreas --version")
  end
end
