class Endreas < Formula
  ...
  url "https://github.com/unisis-unil/endreas-cli.git", tag: "v0.4.0", revision: "17262df2190e4b3d2b72d446b21366629b097faa"
  license "MIT"
  ...
  test do
    assert_match "0.4.0", shell_output("#{bin}/endreas --version")
  end
end
